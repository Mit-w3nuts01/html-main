...
$(document).ready(function() {
	...
	$('.dreg_select').attr('data-id','disable');

	//var cheked = $('.dreg_select').attr('data-id');
	function dragAndDrop(dragTarget, dropTarget) {
	  ...
	  $(dragTarget).draggable({ 
		drag: function(event, ui) {
			var cheked_rt = $('.dreg_select').attr('data-id');
			if(cheked_rt == 'disable'){
				$(".dreg_select[data-id='disable']").addClass("c-drop-target--correct").droppable("disable");
			}
			$(this).parent().removeClass("c-drop-target--correct");
			$(this).parent().removeClass("ui-droppable-disabled");
			$(this).parent().removeClass("c-drop-target--correct").droppable("enable");
	...
	dragAndDrop(".drag_ntr", ".ends_rt");
	dragAndDrop(".drag_ntr_new", ".dreg_select");
}); 
