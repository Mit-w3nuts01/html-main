	...
	jQuery(".step_btn button").on('click', function(e) {
		...
		if(jQuery(this).hasClass('next_btn')){
			if(jQuery('.list_step_form_main .list_step_form.fill').length <	 jQuery('.list_step_form_main .list_step_form').length - 1){
				...
				if(stepid == 'step-6'){
					var radio_val1 = jQuery("input[type='radio'][name='rating1']:checked").val();
					var radio_val2 = jQuery("input[type='radio'][name='rating2']:checked").val();
					var radio_val3 = jQuery("input[type='radio'][name='rating3']:checked").val();
					var radio_val4 = jQuery("input[type='radio'][name='rating4']:checked").val();
					var radio_val5 = jQuery("input[type='radio'][name='rating5']:checked").val();
					var radio_val6 = jQuery("input[type='radio'][name='rating6']:checked").val();
					var radio_val7 = jQuery("input[type='radio'][name='rating7']:checked").val();
					
					
					if((!radio_val1) || (!radio_val2) || (!radio_val3) || (!radio_val4) || (!radio_val5) || (!radio_val6) || (!radio_val7)){
...
// 	  $('.sortable_wrap_drgs > .dreg_select > .drag_ntr').draggable({ 
// 		revert: 'invalid' , 
// 		cursor: "move"
// 	 });
  
// 	  $('.sortable_wrap_drop > .ends_rt').droppable({
// 		revert: "valid",
...
// 	  });
// 	}
// 	dragAndDrop(".sortable_wrap_drgs > .form_col_select > .select_box_main", ".sortable_wrap_drop > .ends_rt");
// 	dragAndDrop(".sortable_wrap_drgs > .form_col_select > .select_box_main", ".sortable_wrap_drgs > .form_col_select ");
  
//   });


$( ".sortable_wrap_drgs > .form_col_select > .select_box_main" ).draggable({
	scope: 'demoBox',
	revertDuration: 100,
	revert: 'invalid' , 
	cursor: "move",
	start: function( event, ui ) {
	  //Reset
	//   $( ".sortable_wrap_drgs > .form_col_select > .select_box_main" ).draggable( "option", "revert", true );
  ...
  $( ".sortable_wrap_drop .ends_rt" ).droppable({
	...
	cursor: "move",
	 drop: function( event, ui ) {
	  // var area = $(this).find(".ends_rt").html();
