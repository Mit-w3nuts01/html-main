...
},{"./10.jpg":"pfi8","./1.jpg":"tF5U","./11.jpg":"BuZG","./12.jpg":"d1lz","./13.jpg":"PXCx","./15.jpg":"G9tc","./14.jpg":"jyIW","./17.jpg":"b5Hy","./16.jpg":"BoeP","./18.jpg":"B6Rf","./19.jpg":"FKO1","./2.jpg":"dsSj","./3.jpg":"RRW1","./20.jpg":"zhsa","./5.jpg":"vF7N","./6.jpg":"WdTg","./4.jpg":"GAhP","./7.jpg":"T4g2","./8.jpg":"UzJD","./9.jpg":"ouaA"}],"MnsR":[function(require,module,exports) {
"use strict";
...
var images = Object.entries(require('../../img/demo1/*.jpg')); // track the mouse position
...
var MenuItem = /*#__PURE__*/function () {
  function MenuItem(el, inMenuPosition, animatableProperties) {
    ...
    this.DOM.textInner = this.DOM.el.querySelector('.services-listing-link'); // create the image structure
...
var Menu = /*#__PURE__*/function () {
  function Menu(el) {
    ...
    this.DOM.menuItems = this.DOM.el.querySelectorAll('.services-listing-link'); // menu item properties that will animate as we move the mouse around the menu
...
// menu (<nav> element)
var menuEl = document.querySelector('.services-listing'); // preload the images set as data attrs in the menu items

(0, _preloader.preloader)('.services-listing-link').then(function () {
